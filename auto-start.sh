...
# Lab test box, and linking all of the NICs together to 
# utilize the network/internet connection on the Mac
#

# Topology file located in GNS3/Projects directory
TOPFILE="$HOME/GNS3/Projects/ASA-LAB/topology.net"

# VMWare Fusion VM location
LABVM="/Users/lykinsbd/Documents/Virtual Machines.localized/Fedora 64-bit.vmwarevm"
...
echo ""
/Applications/VMware\ Fusion.app/Contents/Library/vmrun -T Fusion start "$LABVM" &
